...
def complete_identification_picture(
        scans_dir,
...
#
# scan_path = '/Users/macbook/Desktop/TestUnet/SpineFinder/testing_dataset/4543027.nii.gz'
# scans_dir = '/Users/macbook/Desktop/TestUnet/SpineFinder/testing_dataset/'
# detection_model_path = 'saved_models/detection.h5'
# identification_model_path = 'saved_models/identification.h5'
# models_dir = '/Users/macbook/Desktop/TestUnet/SpineFinder/saved_models'
#
# plot_path = '/Users/macbook/Desktop/TestUnet/SpineFinder/compete_detection_picture'
#
# start = 0
# end = 40

# get_stats(scan_path,
#           'saved_models/detection.h5',
#           'saved_models/identification.h5',
#           spacing=(1.0, 1.0, 1.0))

#
# single_detection(scan_path,
#                  detection_model_path,
#                  plot_path,
#                  spacing=(1.0, 1.0, 1.0))
#
#
# single_identification(scan_path,
#                       detection_model_path,
#                       identification_model_path,
#                       plot_path,
#                       spacing=(1.0, 1.0, 1.0))

# compete_detection_picture(scans_dir,
#                           models_dir,
#                           plot_path,
#                           spacing=(2.0, 2.0, 2.0))


# complete_identification_picture(scans_dir,
#                                 detection_model_path,
#                                 identification_model_path,
#                                 plot_path,
#                                 start,
